...
ch_rev$restId = ch_rev$restId %>% as.factor()
ch_rev$content = ch_rev$content %>% as.character()

rev_cor = Corpus(VectorSource(ch_rev$content), readerControl = list(reader = readPlain, language = "cn"))
